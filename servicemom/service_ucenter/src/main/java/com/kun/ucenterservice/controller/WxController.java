...
import com.kun.ucenterservice.Utils.HttpClientUtils;
...
public class WxController {
        @Autowired
        private UCENTERMEMBERervice ucenterMemberService;
       ...
       //2.获取扫描人信息，添加数据
        ...
        public String callback(String code, String state, HttpSession session){
            try {
                ...
                e.printStackTrace();
                throw new GuLiExceptionHandle(20001,"登录失败");
            }
        }
        ...
        public String getWxCode(){
            ...
            String baseUrl = "https://open.weixin.qq.com/connect/qrconnect" +
                    ...
                    "#wechat_redirect";
            //授权码需要传入加密过的URL,必须使用
            String redirectUrl = ConstantWxUtils.REDIREURL;//获取业务服务器重定向地址
            try {
