package com.kun.edustatic.service.impl;
...
import com.kun.edustatic.mapper.StatisticsDailyMapper;
...
public class StatisticsDailyServiceImpl extends ServiceImpl<StatisticsDailyMapper, StatisticsDaily> implements StatisticsDailyService {
    ...
    @Override
    public void registCountList(String day) {
        //添加记录之前删除表相同日期的数据
        ...
        //远程调用得到某一天注册人数
        R registerR = ucentClient.countOneDay(day);
